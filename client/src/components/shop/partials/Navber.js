  ...
  return (
    <Fragment>
      ...
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-2">
          <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            <span
              onClick={(e) => history.push("/")}
              style={{ letterSpacing: "0.10rem" }}
              className="flex items-left text-left font-bold uppercase text-gray-800 text-2xl cursor-pointer px-2 text-left"
            >
              Cosmoz
            </span>
          </div>
          <div
            ...
            className="hidden lg:block flex items-left col-span-1 text-left text-gray-800 font-bold tracking-widest uppercase text-2xl cursor-pointer"
          >
            Cosmoz
          </div>
